...
impl ServeAdapter {
    ...
    pub fn parse_usage(v: &Value) -> Option<TokenUsage> {
        ...
        Some(TokenUsage {
            input_tokens: v["input_tokens"].as_u64().or_else(|| v["prompt"].as_u64()).unwrap_or(0) as u32,
            output_tokens: v["output_tokens"].as_u64().or_else(|| v["completion"].as_u64()).unwrap_or(0) as u32,
